...
public class GUIMainFrame extends JFrame {
    ...
    JLabel newDeviceTitle = new JLabel();
    ...
    private static final Font labelFont = new Font("Serif",Font.PLAIN, 18);
	...
	public void newDeviceView(String IP) {
	    ...
	    newDevicePanel.setLayout(new MigLayout(" wrap 2, align center ,fillx"));
	    ...
	    newDevicePanel.add(forenameTA, "wrap, width 300, align center");
	    newDevicePanel.add(surname, "width 100, align center");
	    newDevicePanel.add(surnameTA, "wrap, width 300, align center");
	    newDevicePanel.add(ip, "width 100, align center, gaptop 20");
	    newDevicePanel.add(ipTA, "wrap, width 300, align center, gaptop 20");
	    newDevicePanel.add(alias, "width 100, align center, gaptop 20");
	    newDevicePanel.add(aliasTA, "wrap, width 300, align center, gaptop 20");
